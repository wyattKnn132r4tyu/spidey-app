...
export const TAGS: TagMeta[] = [
  { id: 'swinging', label: 'Swinging by', icon: '🕸️', baseWeight: 1 },
  { id: 'stopped-something', label: 'Stopped something', icon: '🚨', baseWeight: 1.4 },
  { id: 'red-blur', label: 'Just a red blur', icon: '💨', baseWeight: 0.6 },
  { id: 'suit-spotted', label: 'Suit spotted', icon: '🦸', baseWeight: 1.2 },
